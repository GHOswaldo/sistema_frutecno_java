...
public class VentaDao {
    ...
    public void pdfV(int idventa, int Cliente, double total, String usuario) {
        try {
            ...
            File salida = new File(url + File.separator + "factura_cliente.pdf");
            archivo = new FileOutputStream(salida);
            Document doc = new Document();
            PdfWriter.getInstance(doc, archivo);
            doc.open();
            Image img = Image.getInstance(getClass().getResource("/Img/fruteria.png"));
            Paragraph fecha = new Paragraph();
            Font negrita = new Font(Font.FontFamily.TIMES_ROMAN, 12, Font.BOLD, new BaseColor(128, 0, 0));
            ...
            PdfPCell c4 = new PdfPCell(new Phrase("Sumatoria", negrita));
            ...
            firma.add("Firma \n\n");
            firma.add("------------------------------------\n");
            firma.add("Agradecemos su preferencia :" + ")" + "\n");
